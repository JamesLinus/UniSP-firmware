...
# also in unisp/unisp.mk and mod/mod.mk

# project name
PROJECT = STM32F334_UniSP
UNISP_DIR = unisp
MOD_DIR = mod
PROJECT_DEFS =
...
# linker script
LD_SCRIPT = $(UNISP_DIR)/STM32F334X8_rom.ld
...
GLOBAL_DEFS = STM32F334x8 ARM_MATH_CM4 __FPU_PRESENT=1
...
PROJECT_DEFS_F = $(patsubst %, -D%, $(PROJECT_DEFS))
...
CXX_FLAGS_F = $(CORE_FLAGS) $(OPTIMIZATION) $(CXX_WARNINGS) $(CXX_FLAGS) $(GLOBAL_DEFS_F) $(CXX_DEFS_F) $(PROJECT_DEFS_F) -MD -MP -MF $(OUT_DIR_F)$(@F:.o=.d) $(INC_DIRS_F)
C_FLAGS_F = $(CORE_FLAGS) $(OPTIMIZATION) $(C_WARNINGS) $(C_FLAGS) $(GLOBAL_DEFS_F) $(C_DEFS_F) $(PROJECT_DEFS_F) -MD -MP -MF $(OUT_DIR_F)$(@F:.o=.d) $(INC_DIRS_F)
AS_FLAGS_F = $(CORE_FLAGS) $(AS_FLAGS) $(GLOBAL_DEFS_F) $(AS_DEFS_F) $(PROJECT_DEFS_F) -MD -MP -MF $(OUT_DIR_F)$(@F:.o=.d) $(INC_DIRS_F)
